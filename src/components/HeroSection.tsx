      ...
      <div className="relative z-20 h-full flex items-center">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              {heroData?.heroTitle || 'Discover Premium Kenyan Properties'}
            </motion.h1>
            ...
            >
              {heroData?.heroSubtitle || 'Premium Properties Across Kenya'}
            </motion.p>
            ...
            >
              {heroData?.heroDescription || 'Premium properties across Kenya curated for the discerning homeowner. Experience elegance, comfort, and sophistication in every detail.'}
            </motion.p>
            ...
            >
              <Link
                href="/properties"
                className="px-6 py-3 md:px-8 md:py-4 bg-transparent border-2 border-indigo-600 text-indigo-600 font-medium rounded-lg hover:bg-indigo-50/15 hover:border-indigo-600 hover:text-indigo-600 transition-colors text-center flex items-center justify-center"
              ...
              <button
                ...
                className="px-6 py-3 md:px-8 md:py-4 bg-transparent border-2 border-green-500 text-green-500 font-medium rounded-lg hover:bg-green-50/15 hover:border-green-600 hover:text-green-600 transition-colors text-center flex items-center justify-center"
              >
